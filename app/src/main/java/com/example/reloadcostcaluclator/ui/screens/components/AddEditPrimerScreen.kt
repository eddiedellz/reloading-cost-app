...
import com.example.reloadcostcaluclator.viewmodel.components.AddEditPrimerViewModel
...
fun AddEditPrimerScreen(
    ...
    onBackClick: () -> Unit,
    onSaved: () -> Unit,
    viewModel: AddEditPrimerViewModel = viewModel(factory = AddEditPrimerViewModel.provideFactory(repository)),
) {
